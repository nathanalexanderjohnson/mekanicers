...
This system is a mekanicers system that you can use as a starting point for building your own custom systems. It's similar to Simple World-building, but has examples of creating attributes in code rather than dynamically through the UI.

## Usage

There are two ways to get started: using the Mekanicers system generator command or manually renaming and updating files.
...
> **Python Generator**
> 
> If you would rather use Python than node, there’s an excellent Python-based generator created by Cussa at https://github.com/Cussa/fvtt-mekanicers-initializator. Give it a shot!
...
Head over to the [Vue3Mekanicers System](https://gitlab.com/asacolips-projects/foundry-mods/vue3mekanicers) repo if you're interested in using Vue!
...
![image](http://mattsmith.in/images/mekanicers.png)
